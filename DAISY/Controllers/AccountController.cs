        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    SendMail.SendEmail(user.Email, "Xác nhận tài khoản của bạn", "Chỉ còn một bước nữa để tạo tài khoản cùng DAISY. Bạn vui lòng click vào <a href=\"" + callbackUrl + "\">đường dẫn này</a> để hoàn tất", "");
